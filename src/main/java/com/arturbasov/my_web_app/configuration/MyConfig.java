...
@Configuration
@ComponentScan(basePackages = "com.arturbasov.my_web_app")
@EnableWebMvc   //замена mvc:annotation-driven
@EnableTransactionManagement    //замена annotation-driven transaction-manager
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.arturbasov.my_web_app.entity");
